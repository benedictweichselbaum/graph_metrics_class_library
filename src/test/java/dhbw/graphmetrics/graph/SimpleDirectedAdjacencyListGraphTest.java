...
class SimpleDirectedAdjacencyListGraphTest extends AbstractTest {

    private Graph<Integer, Integer> graph;

    @BeforeEach
    void setUp() {
        this.graph = new SimpleDirectedAdjacencyListGraph<>();
    }
    ...
    void addEdge() {
        ...
        Assertions.assertEquals(1, this.graph.edges().size());
    }
    ...
    void containsEdge() {
        ...
        Assertions.assertFalse(this.graph.containsEdge(2, 1));
        Assertions.assertFalse(this.graph.containsEdge(3, 1));
    }
}